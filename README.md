...
首選 `survey_video_hevc.mp4`，保留既有 4K HEVC 120fps / 10-bit 影片；另有 H.264 相容版本。兩者直接複製自原專案，沒有重新壓縮。首頁封面擷取自同一影片。

`crops` 共 5 個目錄、28 張照片。依原專案記憶，這組個體目錄與熱帶斑海豚影片物種不一致。頁面已標示比對僅為教學練習，不能作為真實個體辨識或新個體發現依據。正式科學展示前應換上同物種、經確認的個體庫。
